...
while True:
    ...
    if bboxs:
        # get the coordinate
        fx, fy = bboxs[0]["center"][0], bboxs[0]["center"][1]-135
        ...
        cv2.circle(img, (fx, fy), 80, (105, 240, 174), 2)
        # cv2.putText(img, str(pos), (fx + 15, fy - 15), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
        cv2.line(img, (0, fy), (ws, fy), (0, 0, 255), 2)  # x line
        cv2.line(img, (fx, hs), (fx, 0), (0, 0, 255), 2)  # y line
        cv2.circle(img, (fx, fy), 15, (105, 240, 174), cv2.FILLED)
        cv2.putText(img, "TARGET LOCKED", (850, 50), cv2.FONT_HERSHEY_PLAIN, 3, (105, 240, 174), 3)
